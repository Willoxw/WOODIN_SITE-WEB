...
?>
<div class="container pt-4" style="margin-top: 70px;"><a class="btn btn-gold" href="download_invoice.php?id=<?= (int)$order['id'] ?>&amp;token=<?= urlencode($invoiceToken) ?>" download>Telecharger la facture PDF</a><?php if (currentCustomer()): ?><a class="btn btn-outline-dark ms-2" href="client/mes-factures.php">Voir toutes mes factures</a><?php else: ?><p class="mt-2">Conservez ce lien, il vous permettra de retrouver votre facture à tout moment.</p><?php endif; ?></div>
