...
$error = '';
$oauthError = isset($_GET['oauth_error']) ? 'La connexion sociale a échoué. Vérifiez la configuration du fournisseur puis réessayez.' : '';
